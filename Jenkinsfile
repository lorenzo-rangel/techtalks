...
node {
    ...
    stage('config') {
        ...
        sh "export PATH=$PATH:/var/jenkins_home/workspace/testproject-pipeline/apache-maven-3.6.3/bin"
    }
    stage('Maven build') {
        sh "apache-maven-3.6.3/bin/mvn clean package -f /var/jenkins_home/workspace/testproject-pipeline"
